...
app: $(APP_NAME)-native ## Create an Work-break.app
app-universal: $(APP_NAME)-universal ## Create a universal Work-break.app
$(APP_NAME)-%: $(TARGET)-%
...
dmg: $(DMG_NAME)-native ## Create an Work-break.dmg
dmg-universal: $(DMG_NAME)-universal ## Create a universal Work-Break.dmg
$(DMG_NAME)-%: $(APP_NAME)-%
